...
public class G10TablePage implements TablePage {
	 ...
	 */
	public G10TablePage(TableSchema schema, byte[] binaryPage) throws PageFormatException {
	 ...
	 * @param newPageNumber
	 */
	public G10TablePage(TableSchema schema, byte[] binaryPage, int newPageNumber) throws PageFormatException {
